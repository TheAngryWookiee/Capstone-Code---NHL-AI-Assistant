...
columns_to_exclude = ['games_played']  # Exclude 'games_played' but retain 'season' for splitting
...
# List of stats to normalize per game
stats_per_game = [
    'I_F_highDangerShots', 'I_F_oZoneShiftStarts', 'I_F_savedShotsOnGoal', 
...
# Normalize each stat per game
for stat in stats_per_game:
    df[stat] = df[stat] / df['games_played']

# Ensure faceoffsLost is reversed (lower is better)
...
]  # Exclude 'games_played' and 'season'
